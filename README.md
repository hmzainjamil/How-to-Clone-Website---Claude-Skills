...
> Step-by-step guide to cloning websites with Claude Skills
...
|---------|-------------|--------|
| Core — Step-by-step foundation for clone workflows | Core foundation — the primary abstraction this repo builds on | [docs](#) |
| Execution — task decomposition and clone routing | Execution layer — how tasks get decomposed and routed | [docs](#) |
...
```bash
# Quick start
python3 main.py --task "clone task here"

# Power user shortcut
python3 main.py --clone --fast
...
Use How-to-Clone-Website---Claude-Skills to automate step-by-step guide to cloning websites with claude skills. Perfect for agencies, freelancers, and AI-first teams running clone workflows at scale.
...
```bash
# Add to CLAUDE.md
echo "Auto-activate: clone, website" >> ~/.claude/CLAUDE.md

# Or load skill directly
/load-skill How-to-Clone-Website---Claude-Skills
```
...
{
  "hooks": {
    "PostToolUse": [{"matcher": "clone", "command": "python3 ~/repos/How-to-Clone-Website---Claude-Skills/main.py"}]
  }
}
```
...
```bash
# Fork and clone
gh repo fork hmzainjamil/How-to-Clone-Website---Claude-Skills --clone
cd How-to-Clone-Website---Claude-Skills
